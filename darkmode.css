...
/** Wikipedia Dark Mode *******
 * Forked from MediaWiki:Gadget-Blackskin.css by [[:it:Utente:Kormoran]]
 * Made by [[user:jltml]]
 * Variable colors from https://developer.apple.com/design/human-interface-guidelines/ios/visual-design/color/
 */
:root {
	--color-background: #000;
	--color-body: #FFF;
	--color-heading: #FFF;
	--color-accent1: rgb(142, 142, 147);
	--color-accent2: rgb(99, 99, 102);
	--color-accent3: rgb(72, 72, 74);
	--color-accent4: rgb(58, 58, 60);
	--color-accent5: rgb(44, 44, 46);
	--color-accent6: rgb(28, 28, 30);
	--color-a: rgb(100, 210, 255);
	--color-a-hover: rgb(10, 132, 255);
	--color-test: #bf22ad;
}
@media screen {
...
/* Selection highlight */
/*
::-moz-selection { color: #90FF90; background: var(--color-accent2); }
::selection      { color: #90FF90; background: var(--color-accent2); } 
*/
...
legend {
    border: 1px solid var(--color-accent5); /* @theme */
}
input[type="number"],
input[type="text"],
input:not([type]),
...
/* Tabular tables */
table.wikitable {
  border-color: var(--color-accent5) !important;
  color: var(--color-body)!important;
}
...
.oo-ui-windowManager-modal > .oo-ui-dialog > .oo-ui-window-frame p, body, label, span {
	color: var(--color-body);
}
...
.oo-ui-tagItemWidget {
    ...
    background-image: linear-gradient(to bottom,#222 0,var(--color-background) 100%);
    color: #eee;
}
...
.oo-ui-buttonElement-framed.oo-ui-flaggedElement-progressive > .oo-ui-buttonElement-button {
    background-color: var(--color-accent6);
    background-image: linear-gradient(to bottom, --var(color-accent3) 0, var(--color-accent2) 100%);
}
...
#pagehistory li.selected {
    background-image: linear-gradient(var(--color-accent5),var(--color-background));
    border: 1px solid var(--color-accent6);
}
span.autocomment { color: var(--color-accent2); }
...
/* Vector Tabs */
div.vectorTabs, div.vectorTabs span { /* left and right tab breaks */
    /* https://en.wikipedia.org/w/skins/Vector/images/tab-break.png */
    background-image:none;
}
div.vectorTabs { border-left:1px solid black; }
div.vectorTabs span { border-right:1px solid black; }
div.vectorTabs ul li {
    /* https://en.wikipedia.org/w/skins/Vector/images/tab-normal-fade.png */
    background-image: linear-gradient(var(--color-accent5),var(--color-accent6));
...
.template-documentation {
    background-color: var(--color-accent6)!important;
}
...
.mw-trackedTemplate {
    background: var(--color-accent6) linear-gradient(#333, var(--color-background)) !important;
...
table.tmbox, table.tmbox th, table.tmbox td {
...
#centralNotice, #cnotice-main { background-color:var(--color-background)!important; color:inherit!important; }
/* de's Flaggedrev */
.flaggedrevs-color-1 {
...
body.skin-monobook #content div.thumb {          /* "Margin" for thumbs, padding for galleries */
	background-color: var(--color-background)700;   /* Light blue */
}
body.skin-monobook #p-cactions li a {
	background-color: var(--color-background)700;   /* Light blue-gray inactive tabs */
}
...
body.skin-monobook.ns-0 #content div.thumb {
	background-color: var(--color-background);     /* Set back for articles */
}
...
.navpopup {
    ...
    color: var(color-body);
    box-shadow: 0 3px 8px var(--color-accent2);
}
.popup_mainlink a {
     color: var(--color-a);   
}
...
.mwe-popups {
    background-color: var(--color-background);
    box-shadow: /* tint #8e8e93 */
        0 30px 90px -20px rgba(99,99,102,0.3),
        0px 0px 1px rgba(142,142,147,0.5);
}
.mwe-popups p, body {
	color: var(--color-body);
}
...
.mwe-popups.mwe-popups-no-image-tri.flipped_x:before {
    border-bottom-color:var(--color-accent5);
}
.mwe-popups.flipped_y:before,
.mwe-popups.flipped_x_y:before {
    border-top-color:var(--color-accent5);
}
...
.mwe-popups .mwe-popups-extract[dir='ltr']:after {
    background-image: linear-gradient(to right,rgba(0,0,0,0),var(--color-background) 50%);
}
...
#mw-navigation, #mw-head, #mw-panel, #mw-footer {
	background-color: var(--color-accent5)!important;
}
